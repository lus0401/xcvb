...
{
    public class SqliteDataAdapter : IRdbDataAdapter
    {

        public Mutex mutex { get; set; } = new Mutex();
        private SQLiteConnection  DataWriter { get; set; }

        private string FilePath { get { return Path.Combine(AppContext.BaseDirectory, "data.db"); } }
        private string ConnectionString { get { return $"Data Source={FilePath}"; } }
